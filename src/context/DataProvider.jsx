  ...
  posts: [
    {
      ...
      postDescription:
        "Non programmers on my timeline. Attention! After placing 100+ programmers in top Indian startups, I am thinking of coming up with a program for business roles as well. Interested in helping me build this course? Join me at Invact.",
      upvotes: 350,
      downvotes: 50,
...
export const DataProvider = ({ children }) => (
  <DataContext.Provider value={{ forumData: forumData }}>
    {children}
